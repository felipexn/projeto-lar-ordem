...
class ViewModel : ObservableObject{
    ...
    func fetch(){
        guard let url = URL(string: "http://127.0.0.1:1880/lerrr")else {return}
    ...
    func remove(at offsets: IndexSet){
        ...
        guard let url = URL(string: "http://127.0.0.1:1880/deleteConta") else { return }
    ...
    func post(_ obj : Conta){
        ...
        guard let url = URL(string: "http://127.0.0.1:1880/newConta") else { return }
    ...
    func update(_ obj : Conta){
        ...
        guard let url = URL(string: "http://127.0.0.1:1880/updateConta") else { return }
